...
public class ShortestSessionFinder implements Function<SessionsCollection, String> {
        ...
        SleepSession minSession = collection.sessions.stream()
                .min(new Comparator<SleepSession>() {
                    ...
                    public int compare(SleepSession o1, SleepSession o2) {
                        ...
                        return durationO1.compareTo(durationO2);
                    }
                }).orElseThrow(NoSuchElementException::new);

        return "Самая короткая сессия сна была %s и длилась %d часов %d минут.".formatted(
